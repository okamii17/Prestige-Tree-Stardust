...
addLayer("so", {
    ...
    row: 1,
    layerShown() {return layers["s"].best.gte(new Decimal ("80"))},  // Each pair corresponds to a line added to the tree when this node is unlocked. The letter is the other end of the line, and the number affects the color, 1 is default
}, 
)
addLayer("c", {
    startData() { return {
